(function() {
	...
	<ul id="dropuiid" class="fxdropdownmenuclass" style = "padding-inline-start: 12px;">
	...
	<li id="item5" style="display:block;" class="dropdown"><a   href="" class="dropbtn"><slot name="drop-text5"></slot></a></li>
	
	<li id="item6" style="display:block;" class="dropdown"><a   href="" class="dropbtn"><slot name="drop-text6"></slot></a></li>
    ...
    if(childNodes[i].nodeName === 'STYLE') {   //building the inline element style
      childNodes[i].textContent = '.fxdropdownmenuclass{list-style-type:none;background-color:#4D148C;overflow:hidden;width:100%;margin: 0 ;}' + 
