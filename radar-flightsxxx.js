...
<div id='myModal' class = 'modalx' ">
	<div class = 'modal-content'  >
		...
		<input type="button" value="Save" style="float:right;height:35px;width:80px;margin-right:20px;">
...
class radarflightsxxx extends HTMLElement {
...
window.onclick = function(event) {
  if (event.target == modal) {
	...
	window.customElements.define('radar-flightsxxx', radarflightsxxx);  //new standard
